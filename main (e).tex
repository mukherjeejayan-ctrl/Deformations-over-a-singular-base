...
Let $S=k[u,v]$ and $R=S^{\mu_e}$. The trace-zero reflexive module of the double cover near $p$ corresponds to the $R$-module $S_{-2}$ of semi-invariants of character $-2$, since$-(2e+2)\equiv -2 \pmod e.$ By Part $(1)$, every homogeneous component of $f(u,v)$ has degree congruent to $4$ modulo $e$. Hence
$$
...
R\oplus S_{-2}w,
$$
because $gw$ is invariant precisely when $g$ has character $-2$. Under the identification of $S_{-2}$ with the trace-zero reflexive module of $\pi$ near $p$, this invariant algebra is the local double-cover algebra defining $X$ near $q$. Therefore
$$
(X,q)
\simeq
(\widetilde X,0)/\mu_e.
